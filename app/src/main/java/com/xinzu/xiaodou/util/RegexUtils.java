...
//    public static final String PW_REGEX = "(?!^[0-9]+$)(?!^[A-z]+$)(?!^[^A-z0-9]+$)^.{6,12}$";
    /**
     * 匹配8-16位数字、字母、字符的正则表达式
     */
    public static final String PW_REGEX = "^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{4,16}$";

    public static final String PW_REGEX1 = "^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,12}$";
    /**
     * 匹配全网IP的正则表达式
     */
    ...
    /**
     * 匹配汉字的正则表达式，个数限制为2-8个
     */
    public static final String CHINESE_REGEX = "^[\u4e00-\u9f5a]{2,8}$";
...
//    public static final String ID_CARD = "(^\\d{15}$)|(^\\d{17}([0-9]|X)$)";
     ...
     * 字母数字
     **/
    public static final String NUM_LETTER = "^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,12}$";
    /**
    ...
    public static boolean regexNUMLetter(String numLetter) {
       /* Pattern regex = Pattern.compile(NUM_LETTER);
        ...
        Pattern r = Pattern.compile(NUM_LETTER);
        Matcher m = r.matcher(numLetter);
        LogUtils.e("-----------------------------------------------------------------------"+m.matches());
        return m.matches();
    }
    ...
    public static boolean isPWD1(String string) {
        return string.matches(PW_REGEX1);
    }
